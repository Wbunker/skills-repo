...
`query()` creates a new session each time. For multi-turn conversations, use `ClaudeSDKClient` (Python) or `continue: true` (TypeScript) — see [agent-sdk-sessions.md](agent-sdk-sessions.md).
...
Full reference: [agent-sdk-options.md](agent-sdk-options.md)
...
Full hook event list and patterns: [agent-sdk-hooks.md](agent-sdk-hooks.md)
...
Full session patterns: [agent-sdk-sessions.md](agent-sdk-sessions.md)
