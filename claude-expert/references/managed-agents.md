...
See [managed-agents-events.md](managed-agents-events.md) for the full event type list and steering patterns.
...
- [managed-agents-events.md](managed-agents-events.md) — full event type list, steering/interrupt patterns, SSE raw format
- [managed-agents-tools.md](managed-agents-tools.md) — all built-in tools, per-tool config, custom tools, MCP connector
